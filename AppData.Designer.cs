...
namespace RTL.AppDataTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `users` WHERE ((`username` = @p1) AND ((@p2 = 1 AND `password` IS NUL" +
                "L) OR (`password` = @p3)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT * FROM users where username=@username and password=@password";
        ...
        public virtual AppData.usersDataTable Login(string username, string password) {
